...
class BartEncoder(BartPretrainedModel):
    ...
    def forward(
        ...
        image_embedding: Optional[bool] = None,
        extended_attention_mask: Optional[bool] = None,
        ...
        if inputs_embeds is None:
            ...
            # 4.joint text and image
            inputs_embeds = text_embedding + image_emb_new
...
class BartForSequenceClassification(BartPretrainedModel):
    ...
    def forward(
        ...
        # eos_mask = input_ids.eq(self.config.mask_token_id)

        # eos_mask = input_ids.eq(self.config.eos_token_id)
        # wtring by ***
        self.config.mask_token_id = 50264
        eos_mask = decoder_input_ids.eq(self.config.mask_token_id)
